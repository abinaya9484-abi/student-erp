// mockData.js - Updated seed data with 12 Engineering Departments, 8 Semesters & 10 Real Courses
...
// ── 10 Real Subject Courses mapped to semesters ──────────────────────────────
//  1. Programming in C                          → Semester 1
//  2. Programming in C++                        → Semester 2
//  3. Object-Oriented Programming (OOP)         → Semester 2
//  4. Programming in Java                       → Semester 2
//  5. Data Structures and Algorithms            → Semester 3
//  6. Programming in Python                     → Semester 3
//  7. Web Development (HTML, CSS & JavaScript)  → Semester 3
//  8. Database Management System (DBMS)         → Semester 4
//  9. Software Engineering                      → Semester 5
// 10. Mobile Application Development (Android)  → Semester 6
// ─────────────────────────────────────────────────────────────────────────────
const generateMockSubjects = () => {
  ...
  courseIds.forEach(courseId => {
    ...
    list.push(
      ...
      { code: `${deptId}103`, name: 'Programming in C',                        deptId, courseId, semester: 1, credits: 4 }
    );

    // Semester 2
    list.push(
      { code: `${deptId}201`, name: 'Engineering Mathematics II',              deptId, courseId, semester: 2, credits: 4 },
      { code: `${deptId}202`, name: 'Programming in C++',                      deptId, courseId, semester: 2, credits: 3 },
      { code: `${deptId}203`, name: 'Object-Oriented Programming (OOP)',        deptId, courseId, semester: 2, credits: 4 },
      { code: `${deptId}204`, name: 'Programming in Java',                     deptId, courseId, semester: 2, credits: 4 }
    );

    // Semester 3
    list.push(
      { code: `${deptId}301`, name: 'Data Structures and Algorithms',          deptId, courseId, semester: 3, credits: 4 },
      { code: `${deptId}302`, name: 'Programming in Python',                   deptId, courseId, semester: 3, credits: 3 },
      { code: `${deptId}303`, name: 'Web Development (HTML, CSS & JavaScript)',deptId, courseId, semester: 3, credits: 3 }
    );

    // Semester 4
    list.push(
      { code: `${deptId}401`, name: 'Database Management System (DBMS)',       deptId, courseId, semester: 4, credits: 4 },
    ...
    // Semester 5
    list.push(
      { code: `${deptId}501`, name: 'Software Engineering',                    deptId, courseId, semester: 5, credits: 4 },
    ...
    list.push(
      ...
      { code: `${deptId}603`, name: 'Mobile Application Development (Android)',deptId, courseId, semester: 6, credits: 3 }
    );
